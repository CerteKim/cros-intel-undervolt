...
Install [chromebrew](https://github.com/skycocker/chromebrew), gcc will be installed automatically.
...
You can copy `etc/init/intel-undervolt.conf` to /etc/init in order to undervolt on boot.
If you want it starts in daemon mode. use `etc/init/intel-undervolt-daemon.conf` instead.